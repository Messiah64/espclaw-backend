...
export class RealtimeVoiceSession {
  ...
  private instructions(): string {
    return [
      ...
      "Use Gmail, Calendar, Drive, Contacts, Telegram, and device tools directly when they help. Use tools aggressively for real-world actions and device UI updates.",
